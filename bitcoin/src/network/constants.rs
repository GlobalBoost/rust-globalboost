...
impl Network {
    ...
    ///
    /// assert_eq!(Ok(Network::Bitcoin), Network::try_from(Magic::from_bytes([0xA2, 0xB2, 0xE2, 0xF2])));
    ...
    ///
    /// let network = Network::Bitcoin;
    /// assert_eq!(network.magic(), Magic::from_bytes([0xA2, 0xB2, 0xE2, 0xF2]));
    /// ```
...
impl Magic {
    ...
    pub const BITCOIN: Self = Self([0xA2, 0xB2, 0xE2, 0xF2]);
